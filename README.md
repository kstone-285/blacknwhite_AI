...
- **각 AI 모델의 특징**:
  - ***DQN***
    - DQN은 가장 처음 적용해본 모델로, 가장 접근성과 배우기 쉬운 모델이었기에 선택했습니다.  
    그러나 DQN은 흑과백과 같은 **확률기반, 장기전략**이 중요한 게임에서는 적합하지 않았습니다. 해당 이유는 크게 3가지 입니다.
      - 1. DQN은 한 번의 행동에 따른 **즉각적인 보상을 기반으로 학습**하는 경향이 있었습니다.    
      이런 류의 게임은 개별 행동에 대한 리워드보다는 전체 전략, 상대방보다 얼마나 작은 차이로 이기고 큰차이로 지는지에 대한 보상이 중요합니다.
      - 2. **확률적인 요소**와 **심리전 요소**의 **미반영**이 있었습니다.    
